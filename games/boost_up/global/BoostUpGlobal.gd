...
const SAVE_PATH := "user://kt910_collection_boost_up_highscore.json"
const VERSION := 2
...
func load_high_score() -> void:
	...
	if file:
		...
		var loaded_high_score := float(data["high_score"])
...
func make_checksum(score: float, version: int) -> String:
